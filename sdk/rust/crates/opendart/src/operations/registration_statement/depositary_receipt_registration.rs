...
/// Inputs for logical operation `DS006-2020056`.
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct DepositaryReceiptRegistrationInput {
    company_code: String,
    start_date: String,
    end_date: String,
}

impl DepositaryReceiptRegistrationInput {
    ...
    /// Prepares physical operation `get_stkdpRs_json`.
    ///
    /// # Errors
    /// Returns a stable [`PrepareError`] when supplied input violates canonical OpenAPI constraints.
    pub fn prepare_json(
        &self,
    ) -> Result<PreparedRequest<DepositaryReceiptRegistrationJsonResponse>, PrepareError> {
        let operation = OperationIdentity::new("get_stkdpRs_json", "DS006-2020056");
        let parameters = self.parameters(operation)?;
        Ok(PreparedRequest::new(
            RequestParts::structured_json("/api/stkdpRs.json", operation, &parameters),
            decode_depositary_receipt_registration_json_response,
        ))
    }

    /// Prepares physical operation `get_stkdpRs_xml`.
    ///
    /// # Errors
    /// Returns a stable [`PrepareError`] when supplied input violates canonical OpenAPI constraints.
    pub fn prepare_xml(
        &self,
    ) -> Result<PreparedRequest<DepositaryReceiptRegistrationXmlResponse>, PrepareError> {
        let operation = OperationIdentity::new("get_stkdpRs_xml", "DS006-2020056");
        let parameters = self.parameters(operation)?;
        Ok(PreparedRequest::new(
            RequestParts::structured_xml("/api/stkdpRs.xml", operation, &parameters, "result"),
            decode_depositary_receipt_registration_xml_response,
        ))
    }
}
...
pub struct DepositaryReceiptRegistrationSection<'a> {
    source: &'a SourceValue,
    xml: bool,
}

impl<'a> DepositaryReceiptRegistrationSection<'a> {
    ...
    pub fn items(&self) -> impl Iterator<Item = DepositaryReceiptRegistrationEntry<'a>> + '_ {
        items(self.source, "list", self.xml).map(DepositaryReceiptRegistrationEntry::new)
    }
}

/// Borrowed semantic view over `$.group[].list[]`.
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct DepositaryReceiptRegistrationEntry<'a> {
    source: &'a SourceValue,
}

impl<'a> DepositaryReceiptRegistrationEntry<'a> {
...
/// Opaque response for physical operation `get_stkdpRs_json`.
#[derive(Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde-json", derive(serde::Serialize))]
#[cfg_attr(feature = "serde-json", serde(transparent))]
pub struct DepositaryReceiptRegistrationJsonResponse {
    source: SourceValue,
}

impl DepositaryReceiptRegistrationJsonResponse {
    ...
    pub fn items(&self) -> impl Iterator<Item = DepositaryReceiptRegistrationSection<'_>> + '_ {
        items(&self.source, "group", false)
            .map(|source| DepositaryReceiptRegistrationSection::new(source, false))
    }
}

fn decode_depositary_receipt_registration_json_response(
    source: SourceValue,
) -> Result<DepositaryReceiptRegistrationJsonResponse, ResponseDecodeError> {
    decode_depositary_receipt_registration_json_response_root(&source, "$".to_owned())?;
    Ok(DepositaryReceiptRegistrationJsonResponse { source })
}

fn decode_depositary_receipt_registration_json_response_root(
    value: &SourceValue,
    path: String,
    ...
    object.optional(
        "group",
        decode_depositary_receipt_registration_json_response_root_group,
    )?;
    object.optional("status", decode_source_status)?;
    Ok(())
}

fn decode_depositary_receipt_registration_json_response_root_group(
    value: &SourceValue,
    path: String,
) -> Result<(), ResponseDecodeError> {
    decode_array(
        value,
        path,
        decode_depositary_receipt_registration_json_response_root_group_item,
    )?;
    Ok(())
}

fn decode_depositary_receipt_registration_json_response_root_group_item(
    value: &SourceValue,
    path: String,
) -> Result<(), ResponseDecodeError> {
    let object = ObjectDecoder::new(value, path)?;
    object.optional(
        "list",
        decode_depositary_receipt_registration_json_response_root_group_item_list,
    )?;
    Ok(())
}

fn decode_depositary_receipt_registration_json_response_root_group_item_list(
    value: &SourceValue,
    path: String,
) -> Result<(), ResponseDecodeError> {
    decode_array(
        value,
        path,
        decode_depositary_receipt_registration_json_response_root_group_item_list_item,
    )?;
    Ok(())
}

fn decode_depositary_receipt_registration_json_response_root_group_item_list_item(
    value: &SourceValue,
    path: String,
) -> Result<(), ResponseDecodeError> {
...
/// Opaque response for physical operation `get_stkdpRs_xml`.
#[derive(Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde-json", derive(serde::Serialize))]
#[cfg_attr(feature = "serde-json", serde(transparent))]
pub struct DepositaryReceiptRegistrationXmlResponse {
    source: SourceValue,
}

impl DepositaryReceiptRegistrationXmlResponse {
    /// Returns the complete normalized source object.
    #[must_use]
    pub const fn source(&self) -> &SourceValue {
        &self.source
    ...
    pub fn items(&self) -> impl Iterator<Item = DepositaryReceiptRegistrationSection<'_>> + '_ {
        items(&self.source, "group", true)
            .map(|source| DepositaryReceiptRegistrationSection::new(source, true))
    }
}

fn decode_depositary_receipt_registration_xml_response(
    source: SourceValue,
) -> Result<DepositaryReceiptRegistrationXmlResponse, ResponseDecodeError> {
    decode_depositary_receipt_registration_xml_response_root(&source, "$".to_owned())?;
    Ok(DepositaryReceiptRegistrationXmlResponse { source })
}

fn decode_depositary_receipt_registration_xml_response_root(
    value: &SourceValue,
    path: String,
) -> Result<(), ResponseDecodeError> {
    ...
    object.optional(
        "group",
        decode_depositary_receipt_registration_xml_response_root_group,
    )?;
    object.optional("status", decode_source_status)?;
    Ok(())
}

fn decode_depositary_receipt_registration_xml_response_root_group(
    value: &SourceValue,
    path: String,
) -> Result<(), ResponseDecodeError> {
    decode_xml_array(
        value,
        path,
        decode_depositary_receipt_registration_xml_response_root_group_item,
    )?;
    Ok(())
}

fn decode_depositary_receipt_registration_xml_response_root_group_item(
    value: &SourceValue,
    path: String,
) -> Result<(), ResponseDecodeError> {
    let object = ObjectDecoder::new_xml(value, path)?;
    object.optional(
        "list",
        decode_depositary_receipt_registration_xml_response_root_group_item_list,
    )?;
    Ok(())
}

fn decode_depositary_receipt_registration_xml_response_root_group_item_list(
    value: &SourceValue,
    path: String,
) -> Result<(), ResponseDecodeError> {
    decode_xml_array(
        value,
        path,
        decode_depositary_receipt_registration_xml_response_root_group_item_list_item,
    )?;
    Ok(())
}

fn decode_depositary_receipt_registration_xml_response_root_group_item_list_item(
    value: &SourceValue,
    path: String,
) -> Result<(), ResponseDecodeError> {
