...
/// Inputs for logical operation `DS006-2020059`.
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct DemergerRegistrationInput {
    company_code: String,
    start_date: String,
    end_date: String,
}

impl DemergerRegistrationInput {
    ...
    /// Prepares physical operation `get_dvRs_json`.
    ///
    /// # Errors
    /// Returns a stable [`PrepareError`] when supplied input violates canonical OpenAPI constraints.
    pub fn prepare_json(
        &self,
    ) -> Result<PreparedRequest<DemergerRegistrationJsonResponse>, PrepareError> {
        let operation = OperationIdentity::new("get_dvRs_json", "DS006-2020059");
        let parameters = self.parameters(operation)?;
        Ok(PreparedRequest::new(
            RequestParts::structured_json("/api/dvRs.json", operation, &parameters),
            decode_demerger_registration_json_response,
        ))
    }

    /// Prepares physical operation `get_dvRs_xml`.
    ///
    /// # Errors
    /// Returns a stable [`PrepareError`] when supplied input violates canonical OpenAPI constraints.
    pub fn prepare_xml(
        &self,
    ) -> Result<PreparedRequest<DemergerRegistrationXmlResponse>, PrepareError> {
        let operation = OperationIdentity::new("get_dvRs_xml", "DS006-2020059");
        let parameters = self.parameters(operation)?;
        Ok(PreparedRequest::new(
            RequestParts::structured_xml("/api/dvRs.xml", operation, &parameters, "result"),
            decode_demerger_registration_xml_response,
        ))
    }
}
...
pub struct DemergerRegistrationSection<'a> {
    source: &'a SourceValue,
    xml: bool,
}

impl<'a> DemergerRegistrationSection<'a> {
    ...
    pub fn items(&self) -> impl Iterator<Item = DemergerRegistrationEntry<'a>> + '_ {
        items(self.source, "list", self.xml).map(DemergerRegistrationEntry::new)
    }
}

/// Borrowed semantic view over `$.group[].list[]`.
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct DemergerRegistrationEntry<'a> {
    source: &'a SourceValue,
}

impl<'a> DemergerRegistrationEntry<'a> {
...
/// Opaque response for physical operation `get_dvRs_json`.
#[derive(Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde-json", derive(serde::Serialize))]
#[cfg_attr(feature = "serde-json", serde(transparent))]
pub struct DemergerRegistrationJsonResponse {
    source: SourceValue,
}

impl DemergerRegistrationJsonResponse {
    ...
    pub fn items(&self) -> impl Iterator<Item = DemergerRegistrationSection<'_>> + '_ {
        items(&self.source, "group", false)
            .map(|source| DemergerRegistrationSection::new(source, false))
    }
}

fn decode_demerger_registration_json_response(
    source: SourceValue,
) -> Result<DemergerRegistrationJsonResponse, ResponseDecodeError> {
    decode_demerger_registration_json_response_root(&source, "$".to_owned())?;
    Ok(DemergerRegistrationJsonResponse { source })
}

fn decode_demerger_registration_json_response_root(
    value: &SourceValue,
    path: String,
    ...
    object.optional(
        "group",
        decode_demerger_registration_json_response_root_group,
    )?;
    object.optional("status", decode_source_status)?;
    Ok(())
}

fn decode_demerger_registration_json_response_root_group(
    value: &SourceValue,
    path: String,
) -> Result<(), ResponseDecodeError> {
    decode_array(
        value,
        path,
        decode_demerger_registration_json_response_root_group_item,
    )?;
    Ok(())
}

fn decode_demerger_registration_json_response_root_group_item(
    value: &SourceValue,
    path: String,
) -> Result<(), ResponseDecodeError> {
    let object = ObjectDecoder::new(value, path)?;
    object.optional(
        "list",
        decode_demerger_registration_json_response_root_group_item_list,
    )?;
    Ok(())
}

fn decode_demerger_registration_json_response_root_group_item_list(
    value: &SourceValue,
    path: String,
) -> Result<(), ResponseDecodeError> {
    decode_array(
        value,
        path,
        decode_demerger_registration_json_response_root_group_item_list_item,
    )?;
    Ok(())
}

fn decode_demerger_registration_json_response_root_group_item_list_item(
    value: &SourceValue,
    path: String,
) -> Result<(), ResponseDecodeError> {
...
/// Opaque response for physical operation `get_dvRs_xml`.
#[derive(Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde-json", derive(serde::Serialize))]
#[cfg_attr(feature = "serde-json", serde(transparent))]
pub struct DemergerRegistrationXmlResponse {
    source: SourceValue,
}

impl DemergerRegistrationXmlResponse {
    /// Returns the complete normalized source object.
    #[must_use]
    pub const fn source(&self) -> &SourceValue {
        &self.source
    ...
    pub fn items(&self) -> impl Iterator<Item = DemergerRegistrationSection<'_>> + '_ {
        items(&self.source, "group", true)
            .map(|source| DemergerRegistrationSection::new(source, true))
    }
}

fn decode_demerger_registration_xml_response(
    source: SourceValue,
) -> Result<DemergerRegistrationXmlResponse, ResponseDecodeError> {
    decode_demerger_registration_xml_response_root(&source, "$".to_owned())?;
    Ok(DemergerRegistrationXmlResponse { source })
}

fn decode_demerger_registration_xml_response_root(
    value: &SourceValue,
    path: String,
) -> Result<(), ResponseDecodeError> {
    ...
    object.optional(
        "group",
        decode_demerger_registration_xml_response_root_group,
    )?;
    object.optional("status", decode_source_status)?;
    Ok(())
}

fn decode_demerger_registration_xml_response_root_group(
    value: &SourceValue,
    path: String,
) -> Result<(), ResponseDecodeError> {
    decode_xml_array(
        value,
        path,
        decode_demerger_registration_xml_response_root_group_item,
    )?;
    Ok(())
}

fn decode_demerger_registration_xml_response_root_group_item(
    value: &SourceValue,
    path: String,
) -> Result<(), ResponseDecodeError> {
    let object = ObjectDecoder::new_xml(value, path)?;
    object.optional(
        "list",
        decode_demerger_registration_xml_response_root_group_item_list,
    )?;
    Ok(())
}

fn decode_demerger_registration_xml_response_root_group_item_list(
    value: &SourceValue,
    path: String,
) -> Result<(), ResponseDecodeError> {
    decode_xml_array(
        value,
        path,
        decode_demerger_registration_xml_response_root_group_item_list_item,
    )?;
    Ok(())
}

fn decode_demerger_registration_xml_response_root_group_item_list_item(
    value: &SourceValue,
    path: String,
) -> Result<(), ResponseDecodeError> {
