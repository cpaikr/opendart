...
impl FnlttSinglAcntAll {
    ...
    fn prepare_parts(&self, path: &'static str, identity: OperationIdentity, expected: &'static [Representation], expected_xml_root: Option<&'static str>) -> Result<RequestParts, PrepareError> {
        ...
        require_allowed(identity, "fs_div", &self.fs_div, &["OFS", "CFS"])?;
        let parameters = vec![
            QueryParameter { name: "corp_code", value: QueryValue::Scalar(self.corp_code.as_str()) },
            QueryParameter { name: "bsns_year", value: QueryValue::Scalar(self.bsns_year.as_str()) },
            QueryParameter { name: "reprt_code", value: QueryValue::Scalar(self.reprt_code.as_str()) },
...
impl FnlttSinglIndx {
    ...
    fn prepare_parts(&self, path: &'static str, identity: OperationIdentity, expected: &'static [Representation], expected_xml_root: Option<&'static str>) -> Result<RequestParts, PrepareError> {
        ...
        require_allowed(identity, "idx_cl_code", &self.idx_cl_code, &["M210000", "M220000", "M230000", "M240000"])?;
        let parameters = vec![
            QueryParameter { name: "corp_code", value: QueryValue::Scalar(self.corp_code.as_str()) },
            QueryParameter { name: "bsns_year", value: QueryValue::Scalar(self.bsns_year.as_str()) },
            QueryParameter { name: "reprt_code", value: QueryValue::Scalar(self.reprt_code.as_str()) },
...
mod generated_request_tests {
    ...
    fn every_physical_request_matches_its_generated_vector() {
        {
            let input = FnlttSinglAcnt::new("00126380", "2024", "11013");
        ...
        {
            let input = FnlttMultiAcnt::new(["00126380", "00164779"], "2024", "11013");
            let prepared = input.prepare_json().expect("generated vector must prepare");
            ...
            assert_eq!(prepared.encoded_query(), "corp_code=00126380,00164779&bsns_year=2024&reprt_code=11013");
            assert_eq!(prepared.authentication(), Authentication::ApiKeyQuery);
            assert!(!prepared.encoded_query().contains("crtfc_key"));
            assert_eq!(prepared.expected_representations(), JSON_ONLY);
            assert_eq!(prepared.generator_schema(), GENERATOR_SCHEMA);
        ...
        {
            let input = FnlttXbrl::new("value /+", "11013");
            ...
            assert_eq!(prepared.encoded_query(), "rcept_no=value+%2F%2B&reprt_code=11013");
            assert_eq!(prepared.authentication(), Authentication::ApiKeyQuery);
            assert!(!prepared.encoded_query().contains("crtfc_key"));
        ...
        {
            let input = FnlttSinglAcntAll::new("00126380", "2024", "11013", "OFS");
            let prepared = input.prepare_json().expect("generated vector must prepare");
            ...
            assert_eq!(prepared.encoded_query(), "corp_code=00126380&bsns_year=2024&reprt_code=11013&fs_div=OFS");
            assert_eq!(prepared.authentication(), Authentication::ApiKeyQuery);
            assert!(!prepared.encoded_query().contains("crtfc_key"));
            assert_eq!(prepared.expected_representations(), JSON_ONLY);
            assert_eq!(prepared.generator_schema(), GENERATOR_SCHEMA);
        ...
        {
            let input = FnlttSinglIndx::new("00126380", "2024", "11013", "M210000");
            let prepared = input.prepare_json().expect("generated vector must prepare");
            ...
            assert_eq!(prepared.encoded_query(), "corp_code=00126380&bsns_year=2024&reprt_code=11013&idx_cl_code=M210000");
            assert_eq!(prepared.authentication(), Authentication::ApiKeyQuery);
            assert!(!prepared.encoded_query().contains("crtfc_key"));
            assert_eq!(prepared.expected_representations(), JSON_ONLY);
            assert_eq!(prepared.generator_schema(), GENERATOR_SCHEMA);
        ...
        {
            let input = FnlttCmpnyIndx::new(["00126380", "00164779"], "2024", "11013", "M210000");
            let prepared = input.prepare_json().expect("generated vector must prepare");
            ...
            assert_eq!(prepared.encoded_query(), "corp_code=00126380,00164779&bsns_year=2024&reprt_code=11013&idx_cl_code=M210000");
            assert_eq!(prepared.authentication(), Authentication::ApiKeyQuery);
            assert!(!prepared.encoded_query().contains("crtfc_key"));
            assert_eq!(prepared.expected_representations(), JSON_ONLY);
            assert_eq!(prepared.generator_schema(), GENERATOR_SCHEMA);
