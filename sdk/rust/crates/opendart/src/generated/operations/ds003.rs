...
mod generated_request_tests {
    ...
    fn every_physical_request_matches_its_generated_vector() {
        ...
        {
            let input = FnlttSinglAcntAll::new("00126380", "2024", "11013", "value /+");
            let prepared = input.prepare_json().expect("generated vector must prepare");
            ...
            assert_eq!(prepared.encoded_query(), "corp_code=00126380&bsns_year=2024&reprt_code=11013&fs_div=value+%2F%2B");
            assert_eq!(prepared.authentication(), Authentication::ApiKeyQuery);
            assert!(!prepared.encoded_query().contains("crtfc_key"));
            assert_eq!(prepared.expected_representations(), JSON_ONLY);
            assert_eq!(prepared.generator_schema(), GENERATOR_SCHEMA);
        ...
        {
            let input = FnlttSinglIndx::new("00126380", "2024", "11013", "value /+");
            let prepared = input.prepare_json().expect("generated vector must prepare");
            ...
            assert_eq!(prepared.encoded_query(), "corp_code=00126380&bsns_year=2024&reprt_code=11013&idx_cl_code=value+%2F%2B");
            assert_eq!(prepared.authentication(), Authentication::ApiKeyQuery);
            assert!(!prepared.encoded_query().contains("crtfc_key"));
            assert_eq!(prepared.expected_representations(), JSON_ONLY);
            assert_eq!(prepared.generator_schema(), GENERATOR_SCHEMA);
        ...
        {
            let input = FnlttCmpnyIndx::new(["00126380", "00164779"], "2024", "11013", "value /+");
            let prepared = input.prepare_json().expect("generated vector must prepare");
            ...
            assert_eq!(prepared.encoded_query(), "corp_code=00126380,00164779&bsns_year=2024&reprt_code=11013&idx_cl_code=value+%2F%2B");
            assert_eq!(prepared.authentication(), Authentication::ApiKeyQuery);
            assert!(!prepared.encoded_query().contains("crtfc_key"));
            assert_eq!(prepared.expected_representations(), JSON_ONLY);
            assert_eq!(prepared.generator_schema(), GENERATOR_SCHEMA);
