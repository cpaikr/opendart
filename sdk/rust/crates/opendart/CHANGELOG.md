...
## [0.1.0-beta.2](https://github.com/cpaikr/opendart/compare/opendart-v0.1.0-beta.1...opendart-v0.1.0-beta.2) (2026-08-02)


### ⚠ BREAKING CHANGES

* **rust:** Non-2xx responses no longer decode or return as successful SourceReply values. SDK callers must handle ResponseInterpretError::HttpStatus or ClientError::HttpStatus, and CLI consumers must handle the http_status error envelope and exit code 1.
...
* **rust:** make HTTP outcome handling transport-independent ([5e57296](https://github.com/cpaikr/opendart/commit/5e57296b36e9d42907259ec52adb10b44a9012a2))
...
* **rust:** close review gaps in response safety ([b67d832](https://github.com/cpaikr/opendart/commit/b67d83224a44feaf0ac9277ab9049b80f324e217))
