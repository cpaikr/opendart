...
finalization run automatically afterward. Each new crate uses a one-time
protected bootstrap token, then cuts over to crates.io trusted publishing
without a retained token fallback. See
